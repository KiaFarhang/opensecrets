...
const mockMemberPFDResponse string = `{
    "response": {
        "member_profile": {
            "@attributes": {
                "name": "Pelosi, Nancy",
            ...
            "assets": {
                "asset": [
                    {
                        "@attributes": {
                            "name": "25 Point Lobos - Commercial Property",
            ...
            "transactions": {
                "transaction": [
                    {
                        "@attributes": {
                            "asset_name": "United Football League Sacramento Mountain Lions",
                            "tx_date": "Aug  2 2013",
                            "tx_action": "Purchased",
                            "value_low": "100001",
                            "value_high": "250000"
                ...
                "position": [
                    {
                        "@attributes": {
                            ...
                            "organization": "American University Women & Politics Institute"
                        }
                    }
                ]
            }
